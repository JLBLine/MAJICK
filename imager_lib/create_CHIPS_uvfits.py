...
uv_container = UVContainer(uvfits_files = uvfits_files_list,add_phase_track=add_phase_track,phase_centre=phase_centre)
...
for time_step,time_start in enumerate(range(0,len(uv_container.times),num_time_avg)):
    ...
    ##This is the centre of the very first time step
    #initial_lst = uv_container.initial_LST #- (uv_container.time_res / 2.0) * SOLAR2SIDEREAL*(15.0/3600.0)
